...
'click add to cart'
WebUI.click(findTestObject('Object Repository/TC_AddToCart/btn_AddToCart',[('index'):'2']))

'input quantity '
WebUI.setText(findTestObject('Object Repository/TC_AddToCart/input_QuantityValue',[('quantity'):'addtocart_4.EnteredQuantity']), '1')
...
WebUI.verifyTextPresent('The minimum quantity allowed for purchase is 2.', false)
'take screenshot'
Date today = new Date()
