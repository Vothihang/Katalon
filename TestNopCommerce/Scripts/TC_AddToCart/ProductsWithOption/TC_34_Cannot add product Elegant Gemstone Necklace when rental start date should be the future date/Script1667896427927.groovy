...
'input start date'
WebUI.setText(findTestObject('Object Repository/TC_AddToCart/input_QuantityValue',[('quantity'):'rental_start_date_40']), '10/1/2022')

'input end date'
WebUI.setText(findTestObject('Object Repository/TC_AddToCart/input_QuantityValue',[('quantity'):'rental_end_date_40']), '10/2/2022')
...
WebUI.verifyTextPresent('Rental start date should be the future date', false)
