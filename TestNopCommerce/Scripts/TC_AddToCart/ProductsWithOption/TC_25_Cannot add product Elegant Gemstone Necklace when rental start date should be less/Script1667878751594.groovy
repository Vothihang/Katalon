...
'input start date'
WebUI.setText(findTestObject('Object Repository/TC_AddToCart/input_QuantityValue',[('quantity'):'rental_start_date_40']), GlobalVariable.endDate)

'input end date'
WebUI.setText(findTestObject('Object Repository/TC_AddToCart/input_QuantityValue',[('quantity'):'rental_end_date_40']), GlobalVariable.startDate)
...
WebUI.verifyTextPresent('Rental start date should be less than end date', false)
