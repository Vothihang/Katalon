...
'input start date'
WebUI.setText(findTestObject('Object Repository/TC_AddToCart/input_QuantityValue',[('quantity'):'rental_start_date_40']), GlobalVariable.startDate)

'input end date'
WebUI.setText(findTestObject('Object Repository/TC_AddToCart/input_QuantityValue',[('quantity'):'rental_end_date_40']), '')
...
WebUI.verifyTextPresent('Enter rental end date', false)
