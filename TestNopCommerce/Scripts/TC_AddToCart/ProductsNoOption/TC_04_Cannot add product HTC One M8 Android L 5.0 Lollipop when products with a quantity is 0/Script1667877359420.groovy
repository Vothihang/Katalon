...
'input quantity '
WebUI.setText(findTestObject('Object Repository/TC_AddToCart/input_QuantityValue',[('quantity'):'addtocart_18.EnteredQuantity']), '0')
...
WebUI.verifyTextPresent('Quantity should be positive', false)
