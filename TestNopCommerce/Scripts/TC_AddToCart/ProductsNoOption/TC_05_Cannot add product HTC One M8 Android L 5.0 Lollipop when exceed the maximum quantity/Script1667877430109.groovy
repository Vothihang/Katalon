...
'click img product HTC One M8 Android L 5.0 Lollipop'
WebUI.click(findTestObject('Object Repository/TC_AddToCart/a_NameProduct'))

'input quantity '
WebUI.setText(findTestObject('Object Repository/TC_AddToCart/input_QuantityValue',[('quantity'):'addtocart_18.EnteredQuantity']), '8159')
...
WebUI.verifyTextPresent('Your quantity exceeds stock on hand. The maximum quantity that can be added is 8158', false)
