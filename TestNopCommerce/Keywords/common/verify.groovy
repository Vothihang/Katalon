...
public class verify {
	...
	@Keyword
	public boolean verifyElementChecked(TestObject objectReference) {
		try {
			WebUiCommonHelper.findWebElement(objectReference,10)
			return true;
		} catch (Exception e) {
	...
	@Keyword
	public boolean verifyElementNotChecked(TestObject objectReference) {
		return WebUI.verifyElementNotChecked(objectReference, 10, FailureHandling.OPTIONAL)
	}
}
